...
namespace StatsSystem
{
    public class StatsController : IDisposable, IStatValueGiver
    {
        ...
        public void ProcessModificator(StatModificator modificator)
        {
            ...
            var addedValue = modificator.StatModificatorType == StatModificatorType.Addictive
            ...
            else
            {
                ...
                var tempModificator = new StatModificator(addedStat, StatModificatorType.Addictive,
